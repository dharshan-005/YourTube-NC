...
const VideoUploader = ({ channelId, channelName }: any) => {
  ...
  return (
    <div className="bg-gray-50 dark:bg-black dark:text-white rounded-lg p-6">
      <h2 className="text-xl font-semibold mb-4">Upload a video</h2>

      <div className="space-y-4">
        {!videoFile ? (
          <div
            className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center cursor-pointer hover:bg-gray-100 hover:dark:text-black transition-colors hover:dark:border-black"
