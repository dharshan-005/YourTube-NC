  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <Button className="flex items-center gap-2 border border-black dark:border-white dark:bg-black dark:text-white cursor-pointer">
          ...
          <div key={item._id} className="flex gap-4 group">
            <Link href={`/watch/${item.videoid._id}`} className="shrink-0">
              <div className="relative w-40 aspect-video bg-gray-100 rounded overflow-hidden">
                <video
                  src={`${API_URL}/${item.videoid?.filepath}`}
