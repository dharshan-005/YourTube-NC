...
const OtpLogin = () => {
  ...
  // TODO: Implement your IP geolocation or user input to determine state
  // For now assuming Tamil Nadu as example
  const userState = "Tamil Nadu";
  ...
  const handleLogin = async (e?: FormEvent<HTMLFormElement>) => {
    ...
    if (southernStates.includes(userState)) {
      ...
      try {
        await sendSignInLinkToEmail(auth, phoneNumber, actionCodeSettings);
      ...
      {!confirmationResult && (
        <form onSubmit={handleLogin}>
          ...
          <p className="text-xs text-gray-400 mt-2">
            Please enter your phone number to receive an OTP for login.
          </p>
          <Button
